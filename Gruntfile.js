module.exports = function (grunt) {
    ...
    var Astra_theme_Addons = ['background', 'border', 'color', 'customizer-link', 'description', 'divider', 'heading', 'hidden', 'link', 'radio-image', 'responsive', 'responsive-color', 'responsive-background', 'responsive-select', 'responsive-slider', 'responsive-spacing', 'responsive-box-shadow', 'select', 'settings-group', 'slider', 'sortable', 'spacing', 'typography'];
