...
if ( ! function_exists( 'astra_toggle_buttons_markup' ) ) {
	...
	function astra_toggle_buttons_markup() {
		...
		if ( ( $disable_primary_navigation && 'none' == $custom_header_section ) && ( $disable_primary_navigation && true == $hide_custom_menu_mobile ) && ( ! $above_header_merged || ! $below_header_merged ) ) {
			$menu_bottons = false;
		}
